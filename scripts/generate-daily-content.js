...
async function generateItems(category, existingItems, count, seeds = []) {
  ...
  "id": <number>,
  "slug": "<kebab-case>",
  "title": "<50-80 chars — specific, searchable, intriguing — used as the visible H1>",
  "seoTitle": "<≤65 chars — concise keyword-forward variant of title, used as the browser <title> tag. NO ellipsis, NO clickbait. If the title is already ≤65 chars and SEO-friendly, just repeat it.>",
  ...
  "seoTitle": "<≤65 chars — keyword-forward title for the browser <title> tag. NO ellipsis, NO clickbait. If the product title is already ≤65 chars, just repeat it.>",
  ...
  "slug": "<kebab-case>",
  "name": "<tool/site name>",
  "seoTitle": "<≤65 chars — concise keyword-forward title for the browser <title> tag. NO ellipsis, NO clickbait. Usually 'Name — what it does in 4 words'.>",
  ...
  "seoTitle": "<≤65 chars — keyword-forward title for the browser <title> tag. NO ellipsis, NO clickbait.>",
  ...
  "slug": "<kebab-case>",
  "toolName": "<tool name>",
  "seoTitle": "<≤65 chars — keyword-forward title for the browser <title> tag. NO ellipsis, NO clickbait. Usually 'ToolName — what it does in 4 words'.>",
