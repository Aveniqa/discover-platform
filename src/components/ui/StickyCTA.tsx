...
export function StickyCTA({ title, priceRange, ctaUrl, isAffiliate, itemType, provider }: StickyCTAProps) {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 max-w-full overflow-hidden bg-background/97 backdrop-blur-md border-t border-border px-4 py-3 flex items-center justify-between gap-3 md:gap-4 md:px-8 shadow-[0_-8px_30px_rgba(0,0,0,0.35)] transition-transform duration-300"
