...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "An archive of consumer product reviews previously published on Surfaced. The site now focuses on software and tools — these older entries remain online.",
  path: "/trending",
});
      ...
      <section className="depth-scene relative min-h-[55vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 py-24 sm:py-32">
          ...
          <p className="mt-5 text-white/85 text-lg leading-relaxed">
            Surfaced no longer publishes new product reviews — the focus shifted to software and useful
            web apps. These reviews stay online at their original URLs.
          </p>
